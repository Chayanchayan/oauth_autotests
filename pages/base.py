...
class Base:
    ...
    def open_new_tab_and_check_presence(self, locclick,
                                        locpresence):  # ожидаем открытие нового таба и свитчаемся и делаем ассерт,
        # что нужный элемент есть на странице
    ...
    def switch_to_previous_tab(self,
                               number):  # number - номер вкладки на которую хотим свичнуться, сначала используем
        # этот метод, потом закрываем вкладки
